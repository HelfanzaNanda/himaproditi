<head>
    ...
    {{--<script type="text/javascript" src="{{asset('assets/bower_components/matchMedia/matchMedia.js')}}"></script>--}}
    {{--<script type="text/javascript" src="{{asset('assets/bower_components/matchMedia/matchMedia.addListener.js')}}"></script>--}}
